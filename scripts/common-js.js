	...
	$(container).find("input, select, textarea, checkbox" ).each(function(){
		...
		{				
				...
				else
				{
					...
					if(confirm_email != ""){
						if(email_address != confirm_email)
						{
							$('#confirm_email').focus();
							$('#confirm_email').val('');
							$('#confirm_email').prev().addClass('active');
							$('#confirm_email').attr("placeholder", "Please reconfirm the email.")	
							return_state = false;
							return false;
						}
					}
					else
					{
						...
						$('#confirm_email').val('');
						$('#confirm_email').prev().addClass('active');
						$('#confirm_email').attr("placeholder", "Confirm Email cannot be blank!")	
					}
				}
			break;
			...
			else if($(this).val().length < 10)
			{
				...
				$(this).val('');
				$(this).prev().addClass('active');
				$(this).attr("placeholder", "This is not valid mobile number!");							
				return_state = false;
			}
			else
			{
			...
			case "number":
				...
				else
				{
					...
					var confirm_mobile = $('#confirmmobile_no').val();
			...
			case "check":
				...
				{
					var okay = false;
					if($('#check-indi:checked').length > 0)
					{
						okay = true;
						break;
					}
					else {
						alert('Kindly Check agree for accept to the terms & conditions.');
						return_state = false;
						return false;
						}
				}
